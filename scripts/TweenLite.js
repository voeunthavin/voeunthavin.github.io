    ...
    if (!i.TweenLite) {
      ...
      c = function (s, n, r, a) {
        ...
        this.check = function (h) {
          ...
          if (0 === v && r) for (u = ('com.greensock.' + s).split('.'), f = u.pop(), m = l(u.join('.')) [f] = this.gsClass = r.apply(r, o), a && (i[f] = m, 'function' == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + '/' : '') + s.split('.').pop(), [
          ], function () {
            return m
      ...
      P = y.register = function (t, e, i, s) {
        for (var n, r, a, o, l = e.split(','), _ = l.length, u = (i || 'easeIn,easeOut,easeInOut').split(','); --_ > - 1; ) for (r = l[_], n = s ? v('easing.' + r, null, !0)  : h.easing[r] || {
      ...
      r.dispatchEvent = function (t) {
        ...
        s,
        n = this._listeners[t];
        if (n) for (e = n.length, i = this._eventTarget; --e > - 1; ) s = n[e],
        s.up ? s.c.call(s.s || i, {
          type: t,
          target: i
        })  : s.c.call(s.s || i)
      ...
      for (s = [
        ...
        'webkit',
        'o'
      ], n = s.length; --n > - 1 && !k; ) k = t[s[n] + 'RequestAnimationFrame'],
      ...
      r.eventCallback = function (t, e, i, s) {
        if ('on' === (t || '').substr(0, 2)) {
          ...
          null == e ? delete n[t] : (n[t] = e, n[t + 'Params'] = m(i) && - 1 !== i.join('').indexOf('{self}') ? this._swapSelfInParams(i)  : i, n[t + 'Scope'] = s),
      ...
      var I = v('TweenLite', function (e, i, s) {
        ...
        if (this._overwrite = l = null == l ? Q[I.defaultOverwrite] : 'number' == typeof l ? l >> 0 : Q[l], (o || e instanceof Array || e.push && m(e)) && 'number' != typeof e[0]) for (this._targets = a = u(e), this._propLookup = [
        ], this._siblings = [
        ], n = 0; a.length > n; n++) r = a[n],
        r ? 'string' != typeof r ? r.length && r !== t && r[0] && (r[0] === t || r[0].nodeType && r[0].style && !r.nodeType) ? (a.splice(n--, 1), this._targets = a = a.concat(u(r)))  : (this._siblings[n] = $(r, this, !1), 1 === l && this._siblings[n].length > 1 && K(r, this, null, 1, this._siblings[n]))  : (r = a[n--] = I.selector(r), 'string' == typeof r && a.splice(n + 1, 1))  : a.splice(n--, 1);
      ...
      r._init = function () {
        ...
        } else if (r.runBackwards && 0 !== o) if (this._startAt) this._startAt.render( - 1, !0),
        this._startAt.kill(),
        this._startAt = null;
         else {
          i = {
        ...
        if (e && I._onPluginEvent('_onInitAllProps', this), a && (this._firstPT || 'function' != typeof this.target && this._enabled(!1, !1)), r.runBackwards) for (i = this._firstPT; i; ) i.s += i.c,
        i.c = - i.c,
        i = i._next;
      ...
      r.render = function (t, e, i) {
        ...
        0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > h || h === _) && h !== t && (i = !0, h > _ && (n = 'onReverseComplete')), this._rawPrevTime = a = !e || t || h === t ? t : _);
         else if (1e-7 > t) this._totalTime = this._time = 0,
        this.ratio = this._ease._calcEnd ? this._ease.getRatio(0)  : 0,
        (0 !== o || 0 === l && h > 0 && h !== _) && (n = 'onReverseComplete', s = this._reversed),
        0 > t ? (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (i = !0), this._rawPrevTime = a = !e || t || h === t ? t : _))  : this._initted || (i = !0);
        ...
        if (this._time !== o || i) {
          ...
          for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== o && t >= 0 && (this._active = !0), 0 === o && (this._startAt && (t >= 0 ? this._startAt.render(t, e, i)  : n || (n = '_dummyGS')), this.vars.onStart && (0 !== this._time || 0 === l) && (e || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || T))), r = this._firstPT; r; ) r.f ? r.t[r.p](r.c * this.ratio + r.s)  : r.t[r.p] = r.c * this.ratio + r.s,
          r = r._next;
          ...
          n && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(t, e, i), s && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[n] && this.vars[n].apply(this.vars[n + 'Scope'] || this, this.vars[n + 'Params'] || T), 0 === l && this._rawPrevTime === _ && a !== _ && (this._rawPrevTime = 0))
        }
      },
      r._kill = function (t, e) {
        ...
        if ((m(e) || E(e)) && 'number' != typeof e[0]) for (i = e.length; --i > - 1; ) this._kill(t, e[i]) && (o = !0);
          ...
          if (a) {
            ...
            for (n in l) (r = a[n]) && (r.pg && r.t._kill(l) && (o = !0), r.pg && 0 !== r.t._overwriteProps.length || (r._prev ? r._prev._next = r._next : r === this._firstPT && (this._firstPT = r._next), r._next && (r._next._prev = r._prev), r._next = r._prev = null), delete a[n]),
            h && (s[n] = 1);
